...
setwd("C:/R-Work/webjvs/content/post/2022-06-15-NZTE-brief")
...
##
  ...
  ## Import dataset
  ##
    usage_df <- read_xlsx("Data_Raw/myNZTE usage_Feb_Aug2021.xlsx", sheet = 2) |> 
                    clean_names() |> 
...
We can also visualise search terms via word clouds, to produce something more evocative. The below word cloud is a combination of word searches across both groups.
